...
GIFT_HINTS = ['3 000', '5 000', '7 000', '10 000']
...
%(opts)s
          ...
          <ol class="buy__steps">
            <li><b>Вы отправляете заказ.</b> Кнопка откроет переписку с салоном, текст заказа уже будет набран — останется нажать «отправить».</li>
